...
python basic_annotation_table.py -ib $IB -id $ID -im $IM -e $E -n $N -o ${PREFIX}_basic_table.tsv -db $DB
echo "step 1 done"
##
python annotation_table_extend_gene_details.py -i ${PREFIX}_basic_table.tsv -x $X -o ${PREFIX}_extended_table.tsv
echo "step 2 done"
##
python annotation_table_extend_GOs.py -it ${PREFIX}_extended_table.tsv -im $IM -io $IO -o ${PREFIX}_GOextended_table.tsv
echo "step 3 done"
##
python annotation_table_extend_domains.py -it ${PREFIX}_GOextended_table.tsv -ih $IH -e $EH -o ${PREFIX}_domextended_table.tsv
echo "step 4 done"
##
python annotation_table_extend_accessories.py -it ${PREFIX}_domextended_table.tsv -f $F -t $T -o ${PREFIX}_accextended_table.tsv -sigp $SIGP -org $ORG -seg $SEG -coils $COILS -tm $TM -py2 $PY2
echo "step 5 done"
##
python annotation_table_sequence_details.py -it ${PREFIX}_accextended_table.tsv -an $AN -gm $GM -o ${PREFIX}_final_table.tsv
echo "step 6 done"
##
