...
def gff3_index_add_lines(gff3IndexDict, gff3File, mainTypes):
        # Setup
        knownHeadComments = ('# ORIGINAL', '# PASA_UPDATE', '# GMAP_GENE_FIND', '# EXONERATE_GENE_FIND', '# GEMOMA ANNOTATION', '# APOLLO ANNOTATION') # These are the comment lines we'll handle within this code; anything not like this is ignored
...
# Produce output file
gff3_retrieve_remove_tofile(gff3Index, args.outputFileName, idList, args.mode, args.behaviour)  # At least one of these identifiers should be present in every gene annotation line
