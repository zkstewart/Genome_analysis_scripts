#! python3
# gff3_extract_entries.py
# Program to extract lines from a gff3 formatted file that correspond to
...
and extract entries present in the ID list. Further cleaning is undertaken to produce more compact files
