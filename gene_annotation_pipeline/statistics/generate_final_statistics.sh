...
python ${SCRIPTDIR}/gene_annotation_pipeline/statistics/final_statistics_tabulate.py -g ${GENFILE}.stats -f ${PREFIX}.${SUFFIX}_isos.aa.stats ${PREFIX}.${SUFFIX}_isos.nucl.stats ${PREFIX}.${SUFFIX}_isos.trans.stats ${PREFIX}.${SUFFIX}_main.aa.stats ${PREFIX}.${SUFFIX}_main.nucl.stats ${PREFIX}.${SUFFIX}_main.trans.stats -b busco_results/${PREFIX}.${SUFFIX}_isos_busco.aa/short_summary_${PREFIX}.${SUFFIX}_isos_busco.aa.txt busco_results/${PREFIX}.${SUFFIX}_isos_busco.nucl/short_summary_${PREFIX}.${SUFFIX}_isos_busco.nucl.txt busco_results/${PREFIX}.${SUFFIX}_isos_busco.trans/short_summary_${PREFIX}.${SUFFIX}_isos_busco.trans.txt busco_results/${PREFIX}.${SUFFIX}_main_busco.aa/short_summary_${PREFIX}.${SUFFIX}_main_busco.aa.txt busco_results/${PREFIX}.${SUFFIX}_main_busco.nucl/short_summary_${PREFIX}.${SUFFIX}_main_busco.nucl.txt busco_results/${PREFIX}.${SUFFIX}_main_busco.trans/short_summary_${PREFIX}.${SUFFIX}_main_busco.trans.txt -o ${PREFIX}_tabulated_statistics.txt